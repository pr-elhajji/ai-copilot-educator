...
# TODO a vérifier => google scolar search, dans le projet de l'éducation PbL quels sont les sources à utiliser comme banques d'outils.
...
def generate_report_prompt(question, context, report_format="apa", total_words=1000):
    ...
    return f'Information: """{context}"""\n\n' \
           ...
           f"You MUST write all used source urls at the end of the report as references using APA, and make sure to not add duplicated sources, but only one reference for each.\n" \
...
def generate_resource_report_prompt(question, context, report_format="apa", total_words=1000):
    ...
    return f'"""{context}"""\n\nBased on the above information, generate a bibliography recommendation report for the following' \
           ...
           'Include relevant facts, tables, figures, and numbers whenever available.\n' \
...
def auto_agent_instructions():
    return """
        ...
        task: "what are the most interesting sites in Agadir?"
        response:
        {
            "server:  "🌍 Travel Agent",
...
def generate_report_introduction(question: str, research_summary: str = "") -> str:
    return f"""{research_summary}\n 
        ...
        - The introduction should  include context, background, problematic, objectives  the main question or topic, main contribution and originality.
