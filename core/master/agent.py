...
class GPTResearcher:
    ...
    async def scrape_sites_by_query(self, sub_query):
        ...
        """
        # Get Urls
        sub_query=  sub_query # + "site:researchgate.net"  # TODO make this variable global
    ...
    async def get_subtopics(self):
        ...
        #TODO adopter mes topics => en education quels l'équivalence dans les séquence de résolution de projet.
        # TODO en recherche : l'utilsateur doit pouvoir choisir les subtopics ou les spersonalisées
